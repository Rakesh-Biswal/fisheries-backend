// routes/TeamLeaderRoutes/attendance.js
const express = require('express');
const router = express.Router();
const Attendance = require('../../models/ATTENDANCE/Attendance');
const TLAuth = require('./TeamLeaderAuthMiddlewear');

// Get today's attendance for team leader
router.get('/today', TLAuth, async (req, res) => {
  try {
...
// Start work mode
// Start work mode with detailed error logging
router.post('/work-mode-on', TLAuth, async (req, res) => {
  try {
    const { coordinates, workType = "Office Work" } = req.body;

    console.log('Work mode on request:', { coordinates, workType });
    ...
    const attendanceData = {
      ...
      workType,
      status: 'Active',
      name: req.tl.name || 'Team Leader' // Add name field
    };
    ...
    console.error('COMPLETE ERROR starting work mode:', error);
...
// End work mode
router.post('/work-mode-off', TLAuth, async (req, res) => {
  try {
...
router.get('/history', TLAuth, async (req, res) => {
  try {
