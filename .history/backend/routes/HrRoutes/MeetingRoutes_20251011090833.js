...
const { authenticateToken } = require("../../middleware/HrAuthMiddleware");

// Import department models
const Ceo = require("../../models/CEO");
const TeamLeaderEmployee = require("../../models/TeamLeader");
const ProjectManagerEmployee = require("../../models/ProjectManager");
