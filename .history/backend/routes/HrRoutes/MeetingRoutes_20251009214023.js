...
const Meeting = require("../../models/Meeting/Meeting"); // Import the model
  ...
  try {
    ...
    let filter = {
      $or: [
        ...
        // HR can also see meetings where HR department is involved
...
router.post("/", authenticateToken, async (req, res) => {
  try {
    ...
    const meetingDepartments = departments || [];
