...
router.post("/create", async (req, res) => {
  try {
    ...
    const newHoliday = new Holiday({
      ...
      title,
      description,
      departments: departments.sort(), // Store sorted for consistency
      status,
      startTime,
      endTime,
      displayTime,
...
router.get("/fetch", async (req, res) => {
  try {
    ...
    if (department && department !== "All") {
      filter.departments = department; // This will match if department is in the array
    }
...
router.put("/:id", async (req, res) => {
  try {
    ...
    if (departments) {
      ...
      updateData.departments = departments.sort();
    }
