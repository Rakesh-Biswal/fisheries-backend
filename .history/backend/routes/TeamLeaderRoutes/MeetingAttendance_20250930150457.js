...
const SalesEmployee = require("../../models/SALESEMPLOYEE/SalesEmployeeEmployee"); // Fixed path
const ProjectManager = require("../../models/PROJECTMANAGER/ProjectManagerEmployee"); // Fixed path
